...
class SpaceAttentionV3(nn.Module):
    """
    SpaceAttentionV3
    """
    ...
    def __init__(self,
        ...
        """
        super(SpaceAttentionV3, self).__init__()
    ...
    def forward(self, window_features: torch.Tensor,
        ...
        # Attention #
        # --------- #
        # key as the central window slice
        Q = Q[:, current_slice_index, :].unsqueeze(1)  # B x 1 x hidden_dim
        Q = Q.expand(-1, self.window_size, -1)  # B x K x hidden_dim
