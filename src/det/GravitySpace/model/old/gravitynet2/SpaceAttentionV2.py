...
class SpaceAttentionV2(nn.Module):
    """
    SpaceAttentionV2
    """
    ...
    def __init__(self,
        ...
        """
        super(SpaceAttentionV2, self).__init__()
    ...
    def forward(self,
        ...
        V = window_tokens_V + window_tokens_V[:, current_slice_index, :].unsqueeze(1)  # B x K x hidden_dim
