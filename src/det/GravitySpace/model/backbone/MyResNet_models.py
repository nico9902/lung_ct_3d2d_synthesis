...
from src.det.GravitySpace.model.backbone.ResNet.MyResNet101 import MyResNet101
from src.det.GravitySpace.model.backbone.ResNet.MyResNet152 import MyResNet152
from src.det.GravitySpace.model.backbone.ResNet.MyResNet18 import MyResNet18
from src.det.GravitySpace.model.backbone.ResNet.MyResNet34 import MyResNet34
from src.det.GravitySpace.model.backbone.ResNet.MyResNet50 import MyResNet50
from src.det.GravitySpace.utility.msg.msg_error import msg_error


def MyResNet_models(resnet: int,
                    pretrained: bool,
                    in_channels: int = 3) -> Tuple[Union[MyResNet18, MyResNet34, MyResNet50, MyResNet101, MyResNet152], int]:
    """
    Get ResNet models
    ...
    if in_channels != 3:
        raise ValueError("ResNet backbones only support 3 input channels.")
