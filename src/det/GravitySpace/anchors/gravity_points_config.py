...
from src.det.GravitySpace.anchors.initial_config.initial_dice_config import initial_dice_config
...
from src.det.GravitySpace.utility.msg.msg_config_complete import msg_config_complete
...
def gravity_points_config(config: str,
    ...
    # Keep on CPU to avoid OOM during initialization
    # The model will move it to GPU when needed in forward pass
