...
#from src.det.GravitySpace.evaluation.save_coords import save_coords
#from src.det.GravitySpace.evaluation.msg_plot_complete import msg_plot_complete
...
def FROC_plot(title: str,
    ...
    :param label_x: label x-axis name
    ...
    plt.xlabel('Average number of false positives per {}'.format(label_x))
    plt.xscale('log')
